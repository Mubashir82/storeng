$(document).ready(function() {
    ...
    $('button#pos-save-card').click(function() {
        ...
        // $('.alert-card-charged').hide();
        // $('.alert-card-failed').hide();
        // if(!$('#card_transaction_number').val()) {
        //     $('#card_details_modal .alert-card-failed').html('Transaction ID is required. Have you charged the card first?').fadeIn('slow');
        //     return;
        // }
        // -----
