$(document).ready(function() {
    ...
    $('button#pos-charge-card').click(function(){
        ...
        let card_transaction_number = $('#card_transaction_number').val();
        let card_type = $('#card_type').val();
        let card_month = $('#card_month').val();
        let card_year = $('#card_year').val();
        let card_security = $('#card_security').val(); 
        
        console.log('card_number', card_number);
        console.log('card_holder_name', card_holder_name);
        console.log('card_transaction_number', card_transaction_number);
        console.log('card_type', card_type);
        console.log('card_month', card_month);
        console.log('card_year', card_year);
        console.log('card_security', card_security);
    });
